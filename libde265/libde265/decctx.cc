...
#if SAVE_INTERMEDIATE_IMAGES
    char buf[1000];
    snprintf(buf,1000,"pre-lf-%05d.yuv", img->PicOrderCntVal);
...
#if SAVE_INTERMEDIATE_IMAGES
    snprintf(buf,1000,"pre-sao-%05d.yuv", img->PicOrderCntVal);
    write_picture_to_file(img, buf);
#endif
...
#if SAVE_INTERMEDIATE_IMAGES
    snprintf(buf,1000,"sao-%05d.yuv", img->PicOrderCntVal);
    write_picture_to_file(img, buf);
#endif
}
